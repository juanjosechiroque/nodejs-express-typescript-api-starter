...
describe("API: request ID tracing", () => {
    describe("Given the API is available", () => {
        it("When the request is sent, then returns the client-provided x-request-id", async () => {
        ...
        it("When the request is sent, then generates a UUID x-request-id when the client omits it", async () => {
